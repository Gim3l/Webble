...
export const getCenterPoints = ({
  ...
  const points = [
    { id: nanoid(), x: centerX, y: top }, // topCenter
    { id: nanoid(), x: right, y: centerY }, // rightCenter
    { id: nanoid(), x: centerX, y: bottom }, // bottomCenter
    { id: nanoid(), x: left, y: centerY }, // leftCenter
    { id: nanoid(), x: centerX, y: outerSides.top }, // outerTop
    { id: nanoid(), x: outerSides.right, y: centerY }, // outerRight
    { id: nanoid(), x: centerX, y: outerSides.bottom }, // outerBottom
    { id: nanoid(), x: outerSides.left, y: centerY }, // outerLeft
  ];
...
export const getVerticesFromRectVertex = (
  ...
  return [
    { id: nanoid(), x: left, y: top }, // topLeft
    { id: nanoid(), x: right, y: top }, // topRight
    { id: nanoid(), x: right, y: bottom }, // bottomRight
    { id: nanoid(), x: left, y: bottom }, // bottomLeft
  ];
};
...
export const getOffsetPoint = (
  ...
  switch (box.position) {
    ...
    case Position.Bottom:
      return { id: nanoid(), x: box.x, y: box.y + offset };
    case Position.Left:
      return { id: nanoid(), x: box.x - offset, y: box.y };
    case Position.Right:
      return { id: nanoid(), x: box.x + offset, y: box.y };
  }
};
