...
export class SmartEdge {
  ...
  splitPoints(
    ...
    if (this.isHorizontalLine) {
      ...
      SmartEdge.draggingEdge = {
        dragId,
        start: { id: nanoid(), x: from.start.x + offset, y: to.start.y },
        end: { id: nanoid(), x: from.end.x - offset, y: to.start.y },
      };
      return [
        ...startPoints,
        { id: nanoid(), x: from.start.x + offset, y: from.start.y },
        SmartEdge.draggingEdge.start,
        SmartEdge.draggingEdge.end,
        { id: nanoid(), x: from.end.x - offset, y: from.start.y },
        ...endPoints,
      ];
    } else {
      ...
      SmartEdge.draggingEdge = {
        dragId,
        start: { id: nanoid(), x: to.start.x, y: from.start.y + offset },
        end: { id: nanoid(), x: to.start.x, y: from.end.y - offset },
      };
      return [
        ...startPoints,
        { id: nanoid(), x: from.start.x, y: from.start.y + offset },
        SmartEdge.draggingEdge.start,
        SmartEdge.draggingEdge.end,
        { id: nanoid(), x: from.start.x, y: from.end.y - offset },
        ...endPoints,
      ];
    }
  }
        ...
        if (preY === nextY && preY === targetY) {
          ...
          if (this.next) {
            ...
            SmartEdge.draggingEdge = {
              dragId,
              start: this.previous!.start,
              end: { id: nanoid(), x: from.end.x, y: preY }, // New endpoint (projection)
            };
            return [
              ...startPoints,
              SmartEdge.draggingEdge.start,
          ...
          if (this.previous) {
            ...
            SmartEdge.draggingEdge = {
              dragId,
              start: { id: nanoid(), x: from.start.x, y: nextY! }, // New endpoint (projection)
              end: this.next!.end,
            };
            return [
              ...startPoints,
        ...
        if (preX === nextX && preX === targetX) {
          ...
          if (this.next) {
            ...
            SmartEdge.draggingEdge = {
              dragId,
              start: this.previous!.start,
              end: { id: nanoid(), x: preX, y: from.end.y }, // New endpoint (projection)
            };
            return [
              ...startPoints,
              SmartEdge.draggingEdge.start,
          ...
          if (this.previous) {
            ...
            SmartEdge.draggingEdge = {
              dragId,
              start: { id: nanoid(), x: nextX!, y: from.start.y }, // New endpoint (projection)
              end: this.next!.end,
            };
            return [
              ...startPoints,
  ...
  rebuildEdge = (points: ControlPoint[]) => {
    const edge = getEdgeById(this.ctx.id)! as ReactflowEdgeWithData;
